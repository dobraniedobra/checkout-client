namespace Checkout
{
    public class ApiUrls
    {
        ...
        public static string ShoppingList
            =>
                _shoppingListApiUri ??
                (_shoppingListApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList"));

        public static string ShoppingItem
            =>
                _shoppingListApiUri ??
                (_shoppingListApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/{0}"));

        public static string ShoppingItemUpdate
            =>
                _shoppingListApiUri ??
                (_shoppingListApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/{0}?quantity={1}"));
    }
}